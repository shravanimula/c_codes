...
int main()
{
	...
	{
		int choice;
		printf("\n 1.add_first  2.display  3.count_nodes  4.middle_element   5.exit\n");
		...
		switch(choice)
		{
			...
			case 2:display(head);
			       break;
			case 3:cnt_nodes(head);
			       break;
			case 4:middle_element(head);
			       break;
			case 5:exit(0);
		}
	}
...
void cnt_nodes(struct st *ptr)
{
	...
	printf("No.of nodes in sll is:%d\n",cnt);
}
